 ...
 */
public class jdAgregaPersonas extends javax.swing.JDialog {
    String Codigo;
    String Dvp;
    String Nombre;
   
    public jdAgregaPersonas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Codigo="";
        Dvp="";
    ...
    private void btAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAceptarActionPerformed
        ...
        Dvp =    Grilla.getValueAt(Grilla.getSelectedRow(), 2).toString().trim();
        this.dispose();
    ...
    public void CargaDatos(String Query){
        ...
        try{
            ...
            while(Rs.next()){
                Model.addRow(new Object[]{ Rs.getString("codigo").trim(),Rs.getString("nombre").trim(),Rs.getString("dvp").trim() });
            }
