...
public class jdLiquidaciones_mensuales extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        if (Grilla.getColumnModel().getColumnCount() > 0) {
            ...
            Grilla.getColumnModel().getColumn(71).setMinWidth(0);
            Grilla.getColumnModel().getColumn(71).setPreferredWidth(0);
            Grilla.getColumnModel().getColumn(71).setMaxWidth(0);
        }
                ...
                if (Sql3.GetRowCount() > 0){                                            
                    ...
                    while (Rs3.next()){
                        ...
                        if (Rs3.getString("tipo").equals("1")){             //Dias de FERIADO LEGAL
                            ...
                            dias4 = dias4 + Rs3.getDouble("ndias_horas");  
            ...
            //************************************************************************************************************//     
                ...
                TableModel.addRow(new Object[]{
                                 formatearRut(Rs.getString("rut")+Rs.getString("dvp")),       //COLUMN_0  
                                   ...
                                   "0",               //COLUMN_65 Total a Pagar (psueldosdet)
                                   ...
                                   "",                //COLUMN_70   Descripciom Horas extras (psueldosdet) 
                                   ""                 //COLUMN_71   Descripciom Horas atraso (psueldosdet)
...
//                        }
                        ...
                        else if (Rs2.getString("codigo").equals("202")){                 //BONO CUMPLIMIENTO AÑO LABORAL
     ...
     /*COMISION AFP*/   }else if (Rs2.getString("codigo").equals("12") || Rs2.getString("codigo").equals("15") ||  Rs2.getString("codigo").equals("16") ||
                                  Rs2.getString("codigo").equals("21") || Rs2.getString("codigo").equals("22")  || Rs2.getString("codigo").equals("23") || Rs2.getString("codigo").equals("201") ){                   
 ...
 /*ISAPRE OBLIGATORIO*/ }else if (Rs2.getString("codigo").equals("17") || Rs2.getString("codigo").equals("24") || Rs2.getString("codigo").equals("34") || 
                            ...
                            Grilla.setValueAt(Rs2.getString("descripcion").toString(), i, 71);
