 ...
 */
public class jdGetPrestamos extends javax.swing.JDialog {
    
    public jdGetPrestamos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdGetPrestamos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdGetPrestamos dialog = new jdGetPrestamos(new javax.swing.JFrame(), true);
